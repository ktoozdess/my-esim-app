...
export function HomePage() {
    ...
    const [searchQuery, setSearchQuery] = useState(country?.replaceAll("-", " ") ?? "");
                        ...
                        {visibleCount < filteredPlans.length && (
                            <div className="mt-12 flex justify-center">
                                <button
                                    ...
                                    className="px-8 py-3.5 bg-white border border-slate-200 text-slate-700 font-semibold rounded-2xl hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98] transition-all duration-200 shadow-sm text-sm cursor-pointer"
                                >
                                    Load More Plans
                                </button>
                            </div>
