...
const CRYPTO_CURRENCIES = [
    { name: "USDT", network: "TRC-20 / BEP-20" },
    { name: "TON", network: "Telegram Network" },
    { name: "BTC", network: "Bitcoin Network" },
    { name: "ETH", network: "Ethereum Network" },
    { name: "LTC", network: "Litecoin" },
    { name: "TRX", network: "TRON Network" },
];
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-indigo-50/50 via-white to-[#f8fafc] pt-16 pb-16 lg:pt-24 lg:pb-20 border-b border-slate-200/60">
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 leading-tight">
                            Borderless Connectivity. <br />
                            <span className="text-indigo-600">Powered by Crypto.</span>
                        </h1>

                        <p className="mt-6 max-w-2xl mx-auto text-lg sm:text-xl text-slate-600 font-normal leading-relaxed">
                            Blossom eSIM bridges top-tier global mobile networks with Web3 payment
                    ...
                    <section className="space-y-6">
                        <div className="text-center max-w-xl mx-auto">
                            ...
                            <p className="text-slate-500 text-sm mt-1">
                                Pay with low gas fees across popular crypto networks.
                            </p>
                        </div>

                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                            {CRYPTO_CURRENCIES.map((coin, i) => (
                                <div
                                    key={i}
                                    className="bg-white p-4 rounded-2xl border border-slate-200/80 text-center flex flex-col items-center justify-center space-y-1 shadow-sm hover:border-indigo-300 transition-colors"
                                >
                    ...
                    <section className="bg-indigo-50/60 border border-indigo-100 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div>
                            <h3 className="text-lg font-bold text-slate-900">
                                Need Assistance or Custom Enterprise SLA?
                            </h3>
